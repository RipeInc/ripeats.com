...
Deal.create(corporate_id: 1, deal_title: "Orange County Comes to You", description: "Orange County Buffet for sale", quantity: 25, price: 1800, least_price: 1200, expire: false, expiration: Time.now+86400000);
Deal.create(corporate_id: 1, deal_title: "Chicken Frenzy", description: "Experience this American sensation for a buck", quantity: 10, price: 100, least_price: 1, expire: false, expiration: Time.now+86400000);
