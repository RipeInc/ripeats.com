class Api::DealsController < ApplicationController
  ...
  def deal_params
    params.require(:deal).permit(:id, :created_at, :menu_item_id, :corporate_id, :deal_title, :description, :deal_image, :quantity, :original_price, :price, :least_price, :expire, :expiration)
  end
end
